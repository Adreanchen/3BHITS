...
Reguläre Ausdrücke (regular expressions) auch Repex genannt, sind zeichenketten auf Basis syntaktischer Regeln, die es ermöglichen, Zeichenfolgen zu beschreiben. 

z.B.: Bei einem String soll überprüft werden, ob er nur bestimmte Zeichen enthält, sowie eine Länge >= 1 Zeichen aufweist. Zulässig sind: Buchstaben, Ziffern, spezifische Sonderzeichen
...
| Ausdruck       | selektiert                         |
| -------------- | ---------------------------------- |
| s              | Zeichen s (kein Spezialsymbol)     |
| \s             | Zeichen s                          |
...
| r*             | null Mal oder öfter r              |
| r+             | ein Mal oder öfter r               |
| r?             | null oder ein Mal r                |
| r{i}           | i Mal r                            |
| r{i, }         | i Mal oder öfter r                 |
| r{i,j}         | i bis j Mal r                      |
| r_1r_2         | r_1 gefolgt von r_2                |
